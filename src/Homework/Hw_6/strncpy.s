...
# a1 (source) - область памяти (нуль-терминированная строка), откуда будут скопированы num символов
...
#
# Данное поведение было переопределено ввиду борьбы с утечками памяти и неудобством вручную добавлять null-char к концу строки
# после вызова strncpy
#
...
strncpy:
	...
	#Добавление null-char в конец destination, если source больше чем num (читайте описание поведения)
