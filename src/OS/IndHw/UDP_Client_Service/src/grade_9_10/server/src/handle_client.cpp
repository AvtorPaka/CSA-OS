    ...
    while (continue_processing_client && !server_shutdown_flag) {
        ...
        while (bytes_remaining_in_buffer > 0 && continue_processing_client && !server_shutdown_flag) {
            ...
            if (bytes_remaining_in_buffer >= strlen(MSG_ACQUIRE) &&
                ...
                print_log("Server", philosopher_id, log_buffer);
                snprintf(broadcast_buffer, sizeof(broadcast_buffer), "[Srv P%d] Waits waiter: %s", philosopher_id, WAITER_SEM_NAME);
                broadcast_to_loggers(broadcast_buffer);
                ...
                print_log("Server", philosopher_id, log_buffer);
                snprintf(broadcast_buffer, sizeof(broadcast_buffer), "[Srv P%d] Got waiter", philosopher_id);
                broadcast_to_loggers(broadcast_buffer);
                ...
                print_log("Server", philosopher_id, log_buffer);
                snprintf(broadcast_buffer, sizeof(broadcast_buffer), "[Srv P%d] Tries L-fork: %s", philosopher_id, sem_name_log);
                broadcast_to_loggers(broadcast_buffer);
                ...
                print_log("Server", philosopher_id, log_buffer);
                snprintf(broadcast_buffer, sizeof(broadcast_buffer), "[Srv P%d] Grabbed L-fork %s", philosopher_id, sem_name_log);
                broadcast_to_loggers(broadcast_buffer);
                ...
                print_log("Server", philosopher_id, log_buffer);
                snprintf(broadcast_buffer, sizeof(broadcast_buffer), "[Srv P%d] Tries R-fork: %s", philosopher_id, sem_name_log);
                broadcast_to_loggers(broadcast_buffer);
                ...
                print_log("Server", philosopher_id, log_buffer);
                snprintf(broadcast_buffer, sizeof(broadcast_buffer), "[Srv P%d] Grabbed R-fork %s", philosopher_id, sem_name_log);
                broadcast_to_loggers(broadcast_buffer);
                ...
                if (p_state->has_left_fork) {
                    ...
                    print_log("Server",philosopher_id,log_buffer);
                    snprintf(broadcast_buffer, sizeof(broadcast_buffer), "[Srv P%d] Released L-fork F%d", philosopher_id, p_state->left_fork_idx);
                    broadcast_to_loggers(broadcast_buffer);
                } else {
                ...
                if (p_state->has_right_fork) {
                    ...
                    print_log("Server",philosopher_id,log_buffer);
                    snprintf(broadcast_buffer, sizeof(broadcast_buffer), "[Srv P%d] Released R-fork F%d", philosopher_id, p_state->right_fork_idx);
                    broadcast_to_loggers(broadcast_buffer);
                } else {
                ...
                if (p_state->has_waiter_permission) {
                    ...
                    print_log("Server",philosopher_id,log_buffer);
                    snprintf(broadcast_buffer, sizeof(broadcast_buffer), "[Srv P%d] Released waiter", philosopher_id);
                    broadcast_to_loggers(broadcast_buffer);
                } else {
